      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-200">
          ...
          <div className="space-y-4">
            ...
            value: "115 mg/dL",
            status: "In Range"
          }].map((reading, i) => <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
...
function MetricCard({
  ...
  return <div className="bg-white p-6 rounded-xl border border-gray-200">
