...
export function PatientDashboard() {
    return (
        <Layout userRole="USER" userName="John Doe">
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-white p-6 rounded-xl border border-gray-200">
                        <h2 className="text-lg font-semibold text-gray-800 mb-4">Today's Readings</h2>
                        <div className="space-y-4">
                            {[
                                { time: "7:30 AM", value: "112 mg/dL", status: "In Range" },
                                { time: "12:15 PM", value: "128 mg/dL", status: "Slightly High" },
                                { time: "4:45 PM", value: "115 mg/dL", status: "In Range" },
                            ].map((reading, i) => (
                    ...
                    <div className="bg-white p-6 rounded-xl border border-gray-200">
                        <h2 className="text-lg font-semibold text-gray-800 mb-4">Personal AI Insights</h2>
                        <div className="space-y-4">
                            <div className="p-4 bg-teal-50 rounded-lg border border-teal-100">
                                <div className="flex items-center space-x-2 mb-2">
                                    <Brain className="w-5 h-5 text-teal-600" />
                                    <span className="font-medium text-teal-800">Pattern Detected</span>
                                </div>
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-gray-600">Check blood sugar</span>
                                        <span className="text-sm font-medium text-green-600">3/4 completed</span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-gray-600">Log meals</span>
                                        <span className="text-sm font-medium text-green-600">2/3 completed</span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-gray-600">Physical activity</span>
                                        <span className="text-sm font-medium text-yellow-600">15/30 mins</span>
                                    </div>
                                </div>
                            </div>
                        </div>
